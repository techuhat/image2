...
// GLOBAL TOAST FUNCTION - CONSISTENT ACROSS ALL PAGES
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (toggle) {
        ...
        console.log('Theme toggle initialized on', window.location.pathname);
    } else {
        console.warn('Theme toggle element not found on', window.location.pathname);
    }
